...
//         {!selectedDate ? (
//           <>
//             <div className='flex items-center w-full h-full justify-evenly py-14'>
...
//                     />
//                     <ul className='flex flex-col items-center w-full h-full text-xl font-medium text-caption'>
